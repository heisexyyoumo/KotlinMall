...
class GoodsDetailTabOneFragment : BaseMvpFragment<GoodsDetailPresenter>(), GoodsDetailView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_goods_detail_tab_one, container,
                false)
    }
    ...
    private fun loadData() {
        mPresenter.getGoodsDetailList(activity!!.intent.getIntExtra
        (GoodsConstant.KEY_GOODS_ID, -1))
    ...
    private fun initObserve() {
        Bus.observe<SkuChangedEvent>()
                .subscribe{
                    mSkuSelectedTv.text = mSkuPop.getSelectSku() + GoodsConstant
                            .SKU_SEPARATOR+ mSkuPop.getSelectCount() + "件"
                }.registerInBus(this)
    ...
    override fun onAddCartDetailResult(result: Int) {
